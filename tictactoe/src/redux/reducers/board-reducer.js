...
import { SQUARE_CLICKED, IS_THERE_WINNER, 
         HANDLE_RESTART, HIGHlIGHT_WINNING_SQUARES, 
         CHANGE_TURN, HIGHLIGHT_BUTTON } from "../constants/constants";
     ...
     switch(type){
        case SQUARE_CLICKED : { 
                ...
                let obj = JSON.parse(JSON.stringify(Object.assign({}, _hist, { Turn : _hist.Turn+1, 
                                                                               highlightedButton : _hist.highlightedButton+1,
                                                                               History: [ ..._hist.History, clone ] })));
              return obj;
        }
        case IS_THERE_WINNER : {
            return JSON.parse(JSON.stringify(Object.assign({}, state, {XIsWinner : data })));
        }
        case HANDLE_RESTART : {
            return {
                History : [new Move(jsHelpers.genBoard(), [])],
        ...
        case CHANGE_TURN : {
            return Object.assign({}, JSON.parse(JSON.stringify(state)), { Turn : data });
        }
